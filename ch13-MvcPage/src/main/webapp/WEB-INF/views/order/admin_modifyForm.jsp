	...
	<div class="content-main">
		...
		<form id="order_modify" 
			...
			<ul>
				<li>
					...
					<c:if test="${order.status != 5}">
						<input type="radio" name="status" id="status" value="1" <c:if test="${order.status == 1}">checked</c:if> >배송대기
				...
				<li>
					...
					id="receive_name" maxlength="10" value="${order.receive_name}">
				</li>
				<li>
					<label for="receive_phone">전화번호</label>
					<input type="text" name="receive_phone"
					id="receive_phone" maxlength="15" value="${order.receive_phone}">
				</li>
				<li> <%-- 외부 라이브러리 가져다 쓸꺼 --%>
					<label for="zipcode">우편번호</label>
					<input type="text" name="receive_post"
					id="zipcode" maxlength="5" value="${order.receive_post}">
					...
					id="address1" maxlength="30" value="${order.receive_address1}">
				</li>
					<li>
					<label for="address2">나머지 주소</label>
					<input type="text" name="receive_address2"
					id="address2" maxlength="30" value="${order.receive_address2}">
				</li>
				<li>
			...
			<div class="align-center">
				...
				<input type="button" value="삭제" onclick="loaction.href='deleteOrder.do?order_num=${order.order_num}'">
				</c:if>
